...
CURRENT_IMPLEMENTATION_STEP = 12
...
def build_parse_audit_row(
	*,
	...
	return {
		...
		"raw_record_excerpt": raw_record_excerpt,
	}
...
def main(argv=None) -> int:
	...
	logging.info("Current implemented plan step: %d", CURRENT_IMPLEMENTATION_STEP)
	return 0
