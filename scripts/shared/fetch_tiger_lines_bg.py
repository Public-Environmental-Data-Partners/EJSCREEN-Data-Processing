...
Purpose:
	...
	shared/state_config.json and write them to the configured local shared
	pipeline path or remote S3 destination.

Process summary:
	- Load the external config from ./fetch_tiger_lines_bg_config.json.
	- Read validated state names, postal codes, and FIPS codes from
	  ./state_config.json.
