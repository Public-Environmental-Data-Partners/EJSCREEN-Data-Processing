...
This folder contains, primarily, shared configuration, path-resolution, 
and file-fetching utilities to be used by all indicator
pipelines (o3, pm25, ...). Note that `build_manifest.py` and `resolve_path.py`
