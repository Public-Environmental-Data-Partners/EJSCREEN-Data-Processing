...
#   Rscript test_harness/test_resolve_path.R --storage-mode local --type indicator --name o3 --version 1.0 --key raw_o3
#   Rscript test_harness/test_resolve_path.R --storage-mode remote --type indicator --name o3 --version 1.0 --key raw_o3
